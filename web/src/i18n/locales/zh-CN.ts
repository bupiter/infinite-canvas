export default {
    ...
    config: {
        ...
        localStorage: {
            ...
            readFailed: "读取本地存储失败",
            clearAll: "清除本地数据",
            clearAllTitle: "清除当前浏览器中的全部工作台数据？",
            clearAllDescription: "这会永久删除 API Key、渠道配置、画布、素材、生成记录、Agent 凭据和插件数据，且无法恢复。",
            clearFailed: "清除本地数据失败",
    ...
    voteWorkbench: {
        ...
        firstUseModeration: "提示词和必要的参考内容会发送给内容安全审核服务及生图上游。",
        firstUseBilling: "成功生成会按当前生图分组的计费规则扣费。",
