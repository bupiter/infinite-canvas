export default {
    ...
    voteWorkbench: {
        dataNoticeTitle: "Data and API key notice",
        settingsDescription: "Configure the Vote image API key and manage workbench data stored in this browser",
        dataNotice: "Your image API key is stored only in this browser and is sent only to https://image.vote520.com in the Authorization header. Canvases, references, and generated images also remain in local browser storage. Keys cannot be imported from URLs. Do not save a key on a shared device.",
        keyTitle: "Image-only API key",
        apiLabel: "Fixed API",
        modelLabel: "Fixed model",
        verifyConnection: "Verify connection",
        connectionVerified: "Connection verified. The image-only key has been saved.",
        authenticationFailed: "This key is invalid or expired. Create a new image-only key.",
        groupNotImageOnly: "This key is not assigned to an image-only group that exposes only gpt-image-2.",
        serviceUnavailable: "The image service is temporarily unavailable. Try again later.",
        firstUseTitle: "Confirm data processing and billing",
        firstUseModeration: "Prompts are sent to the content moderation service and image provider.",
        firstUseStorage: "Generated images are temporarily retained in private object storage for up to 2 days.",
        ...
        clearAll: "Clear key and local data",
        clearAllTitle: "Clear all local workbench data?",
        clearAllDescription: "This permanently removes the API key, canvases, references, generated images, tasks, and history stored in this browser.",
        about: "About Vote Infinite Canvas",
        aboutDescription: "Vote Infinite Canvas is based on the open-source Infinite Canvas project and is distributed under the MIT License.",
        upstream: "View the Infinite Canvas upstream project",
    },
    locale: {
        zhCN: "简体中文",
        enUS: "English",
