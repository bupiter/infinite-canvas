export default {
    ...
    config: {
        ...
        localStorage: {
            ...
            clearAllTitle: "Clear all workbench data from this browser?",
            clearAllDescription: "This permanently removes API keys, provider settings, canvases, assets, generation history, Agent credentials, and plugin data. This action cannot be undone.",
    ...
    voteWorkbench: {
        ...
        firstUseModeration: "Prompts and required references are sent to the content moderation service and image provider.",
